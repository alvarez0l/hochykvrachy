		...
		return n(e, [{
			...
			value: function() {
				if (!this._opts.inline) {
					...
					// 	n = t.bottom - e.top + "px",
					// 	i = e.bottom - t.top + "px";
					// this.wrapper.style.top = n, this.wrapper.style.right = "", this.wrapper.style.bottom = "", this.wrapper.style.left = 300;
					// var a = 300,
					// 	r = a.right > window.innerWidth,
					// 	s = a.bottom > window.innerHeight;
					// this.wrapper.style.top = s ? "" : n, this.wrapper.style.right = r ? 0 : "", this.wrapper.style.bottom = s ? i : "", this.wrapper.style.left = r ? "" : 300;
					// var o = (a = 300).right >= a.width,
					// 	l = a.bottom > a.height;
